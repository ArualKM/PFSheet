...
const SEARCH_RPC: Record<string, string | undefined> = {
  ...
  akashic_veil_compendium: "search_akashic_veil_compendium",
  oath_compendium: "search_oath_compendium",
  oath_boon_compendium: "search_oath_boon_compendium",
  threepp_drawback_compendium: "search_threepp_drawback_compendium",
